...
public class ReviewDTO {
	...
	@Schema(description = "작성자 사용자 ID", example = "200", required = true, minimum = "1")
	private Long userId;

	@NotBlank(message = "사용자 닉네임은 필수입니다")
	@Size(max = 50, message = "사용자 닉네임은 50자 이하여야 합니다")
	@Schema(description = "작성자 닉네임", example = "콘서트러버", required = true, maxLength = 50)
	private String userNickname;

	@NotBlank(message = "후기 제목은 필수입니다")
	@Size(max = 100, message = "후기 제목은 100자 이하여야 합니다")
	@Schema(description = "후기 제목", example = "정말 감동적인 콘서트였어요!", required = true, maxLength = 100)
	...
	@Schema(description = "관람 평점 (1-5점)", example = "5", required = true, minimum = "1", maximum = "5")
